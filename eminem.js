...
function saveSong (shuffleSong) {
    fs.writeFile(process.cwd() + '/eminemImproved.txt', shuffleSong + '\r\n', {flag: 'a'}, err => {
        if (err) {
            console.error(err);
        }
    })
